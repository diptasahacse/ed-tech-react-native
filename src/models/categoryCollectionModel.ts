...
export class CourseCategoriesModel extends PaginationModel {
  private readonly data: CategoryModel[];

  constructor(courseCategories: ICourseCategories) {
    super({
      current_page: courseCategories.current_page,
      first_page_url: courseCategories.first_page_url,
      from: courseCategories.from,
      last_page: courseCategories.last_page,
      last_page_url: courseCategories.last_page_url,
      links: courseCategories.links,
      next_page_url: courseCategories.next_page_url,
      path: courseCategories.path,
      per_page: courseCategories.per_page,
      prev_page_url: courseCategories.prev_page_url,
